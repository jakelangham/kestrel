...
!$omp private(tt, tID, i, j, ttW, HnW, ttE, HnE, ttS, HnS, ttN, HnN, Friction, Ero, Depo), &
!$omp shared(ActiveTiles, RunParams, tiles, grid, iHn, Hneps, nd, DragClosure)
      do tt = 1, ActiveTiles%Size
...
!$omp shared(ActiveTiles, tiles, idbdx, idbdy, nXpertile, nYpertile, psib, GeometricCorrectionFactor_gradin)
      do tt = 1, ActiveTiles%Size
         tID = ActiveTiles%List(tt)
...
!$omp shared(ActiveTiles, tiles, grid, idbdx, idbdy, nXpertile, nYpertile, psib, GeometricCorrectionFactor_gradin)
         do tt = 1, ActiveTiles%Size
            tID = ActiveTiles%List(tt)
            ! 1D is much simpler...
            do i = 2, nXpertile
